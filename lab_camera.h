    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::mat4 mat = glm::rotate(glm::mat4(1.0f), angle, glm::normalize(right));
            newvec = mat * newvec;
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::mat4 mat = glm::rotate(glm::mat4(1.0f), angle, glm::normalize(forward));
            glm::vec4 newvec = glm::vec4(right, 1.0);
            newvec = mat * newvec;
            right = glm::normalize(glm::vec3(newvec));
            up = glm::cross(right, forward);
